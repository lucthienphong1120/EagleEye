...
class EagleEye(object):
    ...
    def fire(self):
        ...
        self.printHeader()
        print("Attacking webserver in mode '{0}' with {1} workers running {2} connections each. \n Press CTRL+C to stop.".format(self.method, self.nr_workers, self.nr_sockets))
...
def main():
    ...
    try:
        ...
        eagleeye = EagleEye(url)
        eagleeye.useragents = useragents
        eagleeye.nr_workers = workers
        eagleeye.method = method
        eagleeye.nr_sockets = socks
